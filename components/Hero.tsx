...
const Hero: React.FC = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url('/assets/images/jpg/hero-three.jpg')" }}
    >
      <div className="relative z-20">
        <Header />
      </div>
      <div className=" w-full p-6 md:p-0 container md:mt- mx-auto md:ms-36">
        <div className="row align-items-center md:flex md:justify-between mt-8  ">
          ...
          <div className="col-lg-6 relative -bottom-10 -top-4 md:-top-0 ">
              <div className="">
