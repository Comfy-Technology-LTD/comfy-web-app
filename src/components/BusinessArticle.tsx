...
const BusinessArticle: React.FC = () => {
  return (
    <section
      className="md:h-[820px] h-full md:relative p-6"
      style={{ backgroundImage: "url('/assets/images/png/background-1.png')" }}
    >
      <div className="container mx-auto py-12 md:px-12 md:mt-16">
        <div className=" mb-5 ">
          <h1 className="text-red-600 font-semibold">
            SOLUTIONS FOR ALL YOUR NEEDS
          </h1>
          <h2 className="hidden md:flex mt-8 md:text-4xl font-bold text-gray-900">
            Facultative Reinsurance  <br />
            Broking made simpler with Comfy <br />
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-10  mt-8">
          ...
          <div className="flex-1 md:absolute md:right-32 md:-bottom-10 md:p-4 ">
